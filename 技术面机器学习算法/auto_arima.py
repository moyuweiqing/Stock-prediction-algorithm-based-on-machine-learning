...
# 划分训练集和测试集
train = data[:402]# 2017-2018年的为训练接
valid = data[402:]# 2019年的为测试集
...
# 使用2017-2018的数据进行训练
model = auto_arima(training, start_p=1, start_q=1,max_p=2, max_q=2, m=12,start_P=0, seasonal=True,d=1, D=1, trace=True,error_action='ignore',suppress_warnings=True)
#model = ARIMA(train,order=(1, 1, 1))
model.fit(training)

# 使用2019年的数据进行预测
forecast = model.predict(n_periods=208)
